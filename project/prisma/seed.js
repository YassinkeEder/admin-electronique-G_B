// prisma/seed.ts
import { PrismaClient, UserRole, ProjectStatus, TaskStatus, TaskPriority, KpiType, ProjectRegion, ProjectSector, NotificationType, PermissionAction, PermissionResource, } from "@prisma/client";
...
async function main() {
    ...
    const project1 = await prisma.project.create({
        data: {
            ...
            description: "Digitalisation des services médicaux et dossiers patients.",
    ...
    const project2 = await prisma.project.create({
        data: {
            ...
            description: "Modernisation numérique des écoles publiques de Guinée-Bissau.",
    ...
    const comment1 = await prisma.comment.create({
        data: {
            content: "Le projet avance correctement mais nécessite plus de développeurs.",
            authorId: admin.id,
            projectId: project1.id,
        },
    });
