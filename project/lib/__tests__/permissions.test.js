...
// Corrections : apostrophes dans strings → guillemets doubles
// Import depuis le bon chemin relatif
import { hasPermission, canViewAudit, canCreateProject, canViewProject, canEditProject, canDeleteProject, canManageUsers, canUploadDocuments, canDeleteDocument, canViewBI, canCreateTask, canEditTask, canDeleteTask, canEditProjectRecord, canAccessAdmin, ROLE_PERMISSIONS, } from '../permissions';
// =============================================================================
// ROLE_PERMISSIONS — structure
// =============================================================================
describe('ROLE_PERMISSIONS', () => {
    const roles = ['admin', 'chef_projet', 'decideur', 'public'];
...
describe('canEditProjectRecord', () => {
    ...
    it("chef_projet ne peut pas editer le projet d'un autre", () => {
        expect(canEditProjectRecord('chef_projet', USER_B, USER_A)).toBe(false);
    });
    it('decideur ne peut editer aucun projet', () => {
        expect(canEditProjectRecord('decideur', USER_A, USER_A)).toBe(false);
    });
    it('public ne peut editer aucun projet', () => {
